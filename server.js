...
async function inicializarTablas() {
    try {
        ...
        await pool.query(`CREATE TABLE IF NOT EXISTS sala_participantes (
            ...
            sigue_competencia BOOLEAN DEFAULT TRUE,
        ...
        if (parseInt(checkJugadores.rows[0].count) === 0) {
            const granListaJugadores = [
                // Tus datos de jugadores Panini van acá...
            ];
        ...
        console.log("🔒 Estructura completa de la base de datos verificada y al día.");
